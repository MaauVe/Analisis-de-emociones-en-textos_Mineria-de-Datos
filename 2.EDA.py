...
#---------------Analisis estadístico y nubes de palabras---------------#
...
# Diccionario de emociones por pregunta
emociones = {
...
print("Dimensiones del dataset transformado:", df.shape)
...
sns.countplot(data=df, x='emocion', order=df['emocion'].value_counts().index, palette='Set2')
...
plt.figure(figsize=(8, 5))
sns.boxplot(data=df, x='emocion', y='longitud', palette='Pastel2')
plt.title('Distribución de longitud de respuestas por emoción')
